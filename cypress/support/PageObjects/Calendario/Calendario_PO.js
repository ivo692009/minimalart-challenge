class CalendarioObject {
  contarElementosDiv() {
    ...
    return cy
      .xpath("/html/body/div[2]/div/main/div[2]/div[2]/div[5]") // Selecciona el div padre
  ...
  ValidarMes() {
    ...
    cy.get("#__next > div > main > .Grid_header__yAoy_ > div:nth-child(2)")
      .invoke("text")
      .then((text) => {
  ...
  ValidarDiaDeLaMarmota() {
    ...
    this.contarElementosDiv().then((cantidadElementos) => {
      ...
      if (cantidadDiv <= 2) {
        ...
        cy.get("p")
          ...
          .then(() => {
            ...
            cy.get(
              "div > main > div > .Grid_spaceHolder__IVVTT > .Grid_spaceInMonth__JTF6k:nth-child(5)"
            ).click();
            //Se cliquea el div para crear la nota y se escribe "Dia de la Marmota"
            cy.get(
              ".Grid_modalBody__zvK4C > .Grid_reminderBox__yQ64v > .Grid_reminderContent__pLoKD > .Grid_reminderInput__pQ5qK > textarea"
            )
              .click()
              .type("Dia de la Marmota");
            //Se cliquea la Cruz para cerrar el Div de las notas
            cy.get(
              ".Grid_modal__dk4Wd > .Grid_modalContent__slmaD > .Grid_modalHeader__n8UvY > .Grid_icon__bYeIv > .Grid_customIcon__JyTa0"
            ).click();
          });
      } else {
        cy.get("p")
      ...
      if (cantidadDiv <= 2) {
        ...
        cy.get("p")
          ...
          .then(() => {
            ...
            cy.get(
              ".Grid_spaceHolder__IVVTT > .Grid_spaceInMonth__JTF6k > .Grid_reminders__1zv9q > .Grid_reminder__OelsH > .Grid_reminderDesc__gFOG_"
            ).click();
            //Se cliquea la cruz para borrar la nota
            cy.xpath(
              "/html/body/div[2]/div/main/div[2]/div[3]/div[2]/div[2]/div[1]/div/div[3]/span[2]"
            ).click();
            //Se cliquea la cruz para cerrar el Div de las notas
            cy.get(
              ".Grid_modal__dk4Wd > .Grid_modalContent__slmaD > .Grid_modalHeader__n8UvY > .Grid_icon__bYeIv > .Grid_customIcon__JyTa0"
...
export default CalendarioObject;
